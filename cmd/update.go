...
import (
	...
	"github.com/fatecannotbealtered/caixin-cli/internal/update"
...
var updateConfig = update.Config{
	Tool:       "caixin-cli",
	Repo:       "fatecannotbealtered/caixin-cli",
	NPMPackage: "@fateforge/caixin-cli",
	Version:    version,
	CacheEnv:   "CAIXIN_UPDATE_CACHE_DIR",
	Changelog:  caixincli.ChangelogMarkdown,
}
