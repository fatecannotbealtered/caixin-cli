---
name: Bug Report
about: Report a bug in caixin-cli
title: "[Bug] "
labels: bug
assignees: ''
---
...
- **caixin-cli version**: (run `caixin-cli --version`)
...
<details>
<summary><code>caixin-cli doctor</code> output</summary>

```
(paste the output of `caixin-cli doctor` here)
```
