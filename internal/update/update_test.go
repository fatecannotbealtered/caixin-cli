...
func testConfig(t *testing.T, version string) Config {
	...
	return Config{
		Tool:       "caixin-cli",
		Repo:       "owner/caixin-cli",
		NPMPackage: "@fateforge/caixin-cli",
		Version:    version,
...
func TestDetectInstallMethod(t *testing.T) {
	for path, want := range map[string]InstallMethod{
		"/usr/lib/node_modules/@fateforge/caixin-cli/bin/caixin-cli": MethodNPM,
		`C:\Users\x\AppData\Roaming\npm\caixin-cli.exe`:              MethodNPM,
		"/home/x/go/bin/caixin-cli":                                  MethodBinary,
		"/usr/local/bin/caixin-cli":                                  MethodBinary,
		"":                                                           MethodUnknown,
	} {
